    ...
    items: [
      { routeName: "Schools", label: "School Branches", icon: "git-branch", component: SchoolsScreen, module: "schools" },
      {
        ...
        children: [
          ...
          { routeName: "ClassTimetable", label: "Class Timetable", icon: "calendar", component: ClassTimetableScreen, module: "timetable" },
          { routeName: "ClassAttendance", label: "Class Attendance", icon: "check-square", component: ClassAttendanceScreen, module: "attendance" },
          { routeName: "ClassExams", label: "Class Exams", icon: "edit-2", component: ClassExamsScreen, module: "exams" },
          { routeName: "ClassResults", label: "Class Results", icon: "bar-chart-2", component: ClassResultsScreen, module: "results" },
          { routeName: "ClassDiary", label: "Class Diary", icon: "book-open", component: ClassDiaryScreen, module: "diary" },
